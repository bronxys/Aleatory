// Baileys é ESM - carregar via import() dinâmico
let makeWASocket, downloadContentFromMessage, fetchLatestBaileysVersion,
  useMultiFileAuthState, makeInMemoryStore, DisconnectReason,
  WAGroupMetadata, relayWAMessage, MediaPathMap, mentionedJid,
  processTime, MediaType, Browser, MessageType, Presence, Mimetype,
  Browsers, delay, MessageRetryMap;

// Inicializar Baileys de forma assíncrona
const _baileysReady = (async () => {
  ...
  WAGroupMetadata = baileys.WAGroupMetadata;
  relayWAMessage = baileys.relayWAMessage;
  MediaPathMap = baileys.MediaPathMap;
